...
for (let i = 0; i < bestSellingAlbums.length; i++) {
    console.log("here0 before first if")

    if (bestSellingAlbums[i].artist === "Eagles") {
        salesSum = salesSum + bestSellingAlbums[i].sale;
        console.log(bestSellingAlbums[i]);
        console.log("here1 in first if")
        console.log("here1 before second for")
        for (let j = 0; j < bestSellingAlbums[i].genres.length; j++) {

            console.log("here2 in second for")
            console.log('bestSellingAlbums[i].genres[j] = ' + bestSellingAlbums[i].genres[j])
            if ( bestSellingAlbums[i].genres[j] === "soft rock"){ 
                isBothSoftRock = true;
            }
        }
        console.log("here3 after second for")

    }
    console.log("here4 after first if")
}

console.log(salesSum);
console.log(albumsOfEagles);
albumsOfEagles.sales = salesSum;
console.log(isBothSoftRock);
albumsOfEagles.isBothSoftRock = isBothSoftRock
console.log(albumsOfEagles);

// Do you like it?

            // if ( bestSellingAlbums[i].genres = softrock 
            // powiedz = isBothSoftRock
